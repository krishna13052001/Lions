...
<body>
    ...
    <section class="members container">
        ...
        <?php
        if (
            strpos(strtolower($user['title']), 'region chairperson') !== false
        ) {
            $power = true;
        } else {
        ...
        ?>
        <h2 class="text-center">Region Reports <br><br></h2>
        <h4 class="text-center"><?= $user['regionName'] ?></h4>
        <?php if (!$power) : ?>
        <script>
