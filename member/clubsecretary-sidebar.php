<div class="main-sidebar sidebar-style-2">
                <aside id="sidebar-wrapper">
                    <div class="sidebar-brand">
                        <a href="./home.php"> <img alt="image" src="../img/logo.png" class="header-logo" /> <span class="logo-name"></span>
                        </a>
                    </div>
                    <ul class="sidebar-menu">
                        <li class="menu-header">Club Secretary</li>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="nav-link" href="./sec-pending-activities.php">Pending Activities</a></li>
...
<div class="main-sidebar sidebar-style-2">
                <aside id="sidebar-wrapper">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="dropdown active">
                            <a href="./home-secretary.php" class="nav-link"><i class="fas fa-desktop"></i><span>Dashboard</span></a>
                        </li>
                        <li class="dropdown">
                            <a href="#" class="menu-toggle nav-link has-dropdown"><i class="fas fa-tasks"></i></i><span>Activity Reporting</span></a>
                            <ul class="dropdown-menu">
